...
public class MetricsService
{
    ...
    public MetricsService(IMeterFactory meterFactory)
    {
        ...
        _requestCounter = _meter.CreateCounter<int>(name: "request_count", description: "Number of requests received.");

        _requestDuration = _meter.CreateHistogram<double>(name: "request_duration", unit: "ms",

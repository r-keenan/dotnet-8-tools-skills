...
/// and set the current culture to one of the following:
/// <list type="bullet">
...
public class Utility
{
    ...
    public static void ConfigureConsole(string culture = "en-US", bool useComputerCulture = false)
    {
        // Enable output of symbols like Euro symbol to console
        OutputEncoding = UTF8;
